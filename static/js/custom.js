(function ($) {
    ...
    $(document).ready(function () {
        var proBar = $('#bar1');
        if (proBar.length) {
            proBar.barfiller({barColor: '#508FF4', duration: 1000});
        }
        var proBar = $('#bar2');
        if (proBar.length) {
            proBar.barfiller({barColor: '#FFBF43', duration: 1000});
        }
        var proBar = $('#bar3');
        if (proBar.length) {
            proBar.barfiller({barColor: '#4BE69D', duration: 1000});
        }
        var proBar = $('#bar4');
        if (proBar.length) {
            proBar.barfiller({barColor: '#9267FF', duration: 1000});
        }
    });
